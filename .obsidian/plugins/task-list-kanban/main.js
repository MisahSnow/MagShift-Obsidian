...
function Task($$anchor, $$props) {
  ...
  var node_4 = sibling(div_1, 2);
  {
    var consequent_2 = ($$anchor2) => {
      ...
      event("click", button_1, () => taskActions().viewFile(task().id));
...
var root_62 = from_html(`<button class="add-new-btn svelte-ncpvit"><span class="svelte-ncpvit"></span> Add new</button>`);
...
function Column($$anchor, $$props) {
  ...
  function showMenu(e) {
    ...
    if (get(isSelectMode) && get(selectedCount) > 0) {
      if (column() !== "done") {
        menu.addItem((i) => {
          i.setTitle(`Move ${get(selectedCount)} selected to Done`).onClick(async () => {
  ...
  legacy_pre_effect(() => (deep_read_state(column()), $columnTagTableStore()), () => {
    set(columnTitle, getColumnTitle(column(), $columnTagTableStore()));
  });
  legacy_pre_effect(
  ...
  var node = first_child(fragment);
  {
    var consequent_4 = ($$anchor2) => {
      ...
      var node_4 = sibling(div_8, 2);
      {
        var consequent_3 = ($$anchor3) => {
          ...
          template_effect(() => {
            var _a5;
            return set_attribute2(button_3, "aria-label", `Add new task to ${(_a5 = get(columnTitle)) != null ? _a5 : ""}`);
          });
          event("click", button_3, async (e) => {
    ...
    if_block(node, ($$render) => {
      if (deep_read_state(hideOnEmpty()), deep_read_state(tasks()), untrack(() => !hideOnEmpty() || tasks().length)) $$render(consequent_4);
    });
  }
...
var root_8 = from_html(`<div class="empty svelte-1ul7oo4">No options</div>`);
var root_13 = from_html(`<div role="none"><!> <!> <!></div>`);
var root_10 = from_html(`<span id="aria-selection" class="svelte-1ul7oo4"> </span> <span id="aria-context" class="svelte-1ul7oo4"> </span>`, 1);
...
function Main($$anchor, $$props) {
  ...
  legacy_pre_effect(
    () => (get(showFilepath), get(consolidateTags), get(uncategorizedVisibility), VisibilityOption, get(doneVisibility), get(filtersSidebarExpanded), get(filtersSidebarWidth), get(columnWidth), get(flowDirection), FlowDirection, $settingsStore()),
    () => {
      (($$value) => {
...
var SettingsModal = class extends import_obsidian6.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian6.Setting(this.scrollWrapper).setName("Uncategorized column visibility").setDesc("When to show the Uncategorized column").addDropdown((dropdown) => {
      var _a5;
    ...
    new import_obsidian6.Setting(this.scrollWrapper).setName("Done column visibility").setDesc("When to show the Done column").addDropdown((dropdown) => {
      var _a5;
      dropdown.addOption("always" /* AlwaysShow */, "Always show").addOption("auto" /* Auto */, "Hide when empty").addOption("never" /* NeverShow */, "Never show").setValue(
...
function createTasksStore(vault, workspace, registerEvent, columnTagTableStore, getFilenameFilter, getExcludeFilter, getBoardFolderPath, settingsStore) {
